...
public class OrderDetailProcess {
    ...
    public static List<BuyBillDetail> getBaleInfo(String str){
        ...
        String sql = String.format("SELECT * FROM view_admin_进货单详细 WHERE BUYRECORDID = '%s'", str);
    ...
    public static List<SaleBillDetail> getSaleInfo(String str){
        ...
        String sql = String.format("SELECT * FROM view_admin_售货单详细 WHERE SALERECORDID = '%s'", str);
